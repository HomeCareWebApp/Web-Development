        ...
        <div class="hamburger-menu">
            ...
            <ul class="menu__box">
              @auth
                ...
                @elseif(auth()->user()->role == 'Technician')
                  <li><a class="menu__item" href="/viewOrder">Daftar Pesanan</a></li>
                  <li><a class="menu__item" href="/order/onGoing">Sedang Berlangsung</a></li>
                  <li><a class="menu__item" href="/changeProfile/{{$id}}">Profil</a></li>
                @endif
